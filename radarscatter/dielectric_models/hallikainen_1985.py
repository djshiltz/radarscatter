...
def hallikainen_1985(clay_pct, sand_pct, mv_pct, freq_GHz):
    """
    Computes the complex dielectric constant based on the empirical relations
    ...
    Outputs:
        ep_r  complex dielectric constant of soil/water mixture
    """
    mv_dec = mv_pct/100
